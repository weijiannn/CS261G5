...
class RealTimePoissonSimulationController extends RealTimeGenerativeController with RealTimeController,PoissonGenerator{
  RealTimePoissonSimulationController(IRateParameters p,RunwayAnimationManager runwayAnimationManager) : super(p,runwayAnimationManager){
